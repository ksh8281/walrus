                    ...
                    if (iter->position() != iter->nonOptimizedPosition()) {
                        ...
                        if (binaryReader.m_preprocessData.m_inPreprocess && iter->hasValidLocalIndex()) {
                            ...
                            auto localVariableIter = binaryReader.m_preprocessData
                                .m_localVariableInfo[iter->localIndex()].m_usageInfo.rbegin();
                            while (true) {
                                ASSERT(localVariableIter != binaryReader.m_preprocessData
                                    .m_localVariableInfo[iter->localIndex()].m_usageInfo.rend());
