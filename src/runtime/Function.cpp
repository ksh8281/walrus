...
void Function::intepreterCall(ExecutionState& state, uint8_t* bp, ByteCodeStackOffset* offsets,
...
void Function::call(ExecutionState& state, Value* argv, Value* result)
{
    const FunctionType* ft = functionType();
    ...
    intepreterCall(state, valueBuffer, offsetBuffer, parameterOffsetSize, resultOffsetSize);
...
void DefinedFunction::intepreterCall(ExecutionState& state, uint8_t* bp, ByteCodeStackOffset* offsets,
                                     uint16_t parameterOffsetCount, uint16_t resultOffsetCount)
{
